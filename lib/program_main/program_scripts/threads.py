...
class Thread_protocol(QtCore.QThread):
    """
...
class Protocol_exec_dialog(QtWidgets.QDialog):
    """
    A dialog with a progress bar used when running long and time-consuming functions.
    """

    def __init__(self, app, program, function, args,
                 wait_start=0.15,
                 wait_end=0.15,
                 wait_close=0.20,
        ...
        self.set_check_error = set_check_error
    ...
    #     """
    #     return DockingPieInterruptedProtocol("Interrupted the protocol")
